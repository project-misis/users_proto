...
type CrudClient interface {
	CreateUser(ctx context.Context, in *UserPost, opts ...grpc.CallOption) (*User, error)
...
func (c *crudClient) CreateUser(ctx context.Context, in *UserPost, opts ...grpc.CallOption) (*User, error) {
...
type CrudServer interface {
	CreateUser(context.Context, *UserPost) (*User, error)
...
func (UnimplementedCrudServer) CreateUser(context.Context, *UserPost) (*User, error) {
